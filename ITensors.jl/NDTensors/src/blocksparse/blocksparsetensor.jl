...
# returns block sparse matrix given a block sparse tensor. The tensor merges the indices given in combdims
function permutedims_combine_output(
  ...
  # blocks_perm contains all nonzero blocks of original tensor. Calling this 
  # returns the same set of blocks but for the matrix given by merging indices 
