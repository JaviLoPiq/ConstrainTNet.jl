...
# e.g. (2,-1), (-1,3) -> (2,3) when contracting two rank-2 tensors
...
# from the contraction labels and input indices one can infer the output index. E.g.
# T1is = (dim=5|id=940|"i") <Out>
# 1: QN(0) => 2
# 2: QN(1) => 3, (dim=5|id=156|"j") <In>
# 1: QN(0) => 2
# 2: QN(1) => 3
# T2is = (dim=5|id=156|"j") <Out>
# 1: QN(0) => 2
# 2: QN(1) => 3, (dim=5|id=921|"k") <In>
# 1: QN(1) => 2
# 2: QN(2) => 3
# T1labels = (2, -1) 
# T2labels = (-1, 3)
...
# => the resulting index should have the first component of T1is and second of T2is 
# since the rest are paired
